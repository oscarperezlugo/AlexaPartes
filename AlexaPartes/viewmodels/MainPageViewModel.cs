...
namespace AlexaPartes.viewmodels
{
        ...
        private void OnButtomCommand()
        {
            ...
            page.OnScanResult += (result) =>
            {
                ...
                Device.BeginInvokeOnMainThread(() => {
                    ...
                    {
                        Result = $"Resultad: {result.Text}";
                    }
                });
            };
            Application.Current.MainPage.Navigation.PushModalAsync(new NavigationPage(page) { BarTextColor = Color.White, BarBackgroundColor = Color.Black }, true);
        }
    }
}
